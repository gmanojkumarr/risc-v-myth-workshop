...
\TLV
   ...
   // Test inputs for Load/store instructions
   m4_asm(SW, r0, r10, 100)  // store R10 result in address-4
   m4_asm(LW, r15, r0, 100)  // Load the value in address-4 to R15
   ...
   |cpu
      ...
      @3   
         ...
         $result[31:0] = $is_andi ? $src1_value & $imm :
                         ...
                         $is_slti ? ($src1_value[31] == $imm[31]) ? $sltiu_rslt : {31'd0, $src1_value[31]} :
                         ...
                         $is_slt  ? ($src1_value[31] == $src2_value[31]) ? $sltu_rslt : {31'd0, $src1_value[31]} :
                         $is_sltu ? $sltu_rslt :
